...
class GenerateDartboard():
    ...
    def __init__(self, url):
        ...
        self.dartboard = Dartboard(self.img.shape[:2])
    ...
    def setColours(self):
        ...
        self.colours['white'] = self.img[self.centre_pt[0]
                                         ][self.centre_pt[1] + 50]
        self.colours['black'] = self.img[self.centre_pt[0] +
                                         50][self.centre_pt[1]]
    ...
    def createBoard(self):
        ...
        bullseye = Point(point=(
            self.centre_pt[0], self.centre_pt[1]), colour=self.colours['red'], board_value=50)
        outer_bullseye = Point(point=(
            self.centre_pt[0] + 25, self.centre_pt[1]), colour=self.colours['green'], board_value=25)

        # Each number on the dart board:
        # [lower value, triple, higher value, double]
        twenty = [Point(point=(self.centre_pt[0] - 50, self.centre_pt[1]),
                        colour=self.colours['black'], board_value=20),
                  Point(point=(self.centre_pt[0] - 270, self.centre_pt[1]),
                        colour=self.colours['red'], board_value=60),
                  Point(point=(self.centre_pt[0] - 290, self.centre_pt[1]),
                        colour=self.colours['black'], board_value=20),
                  Point(point=(self.centre_pt[0] - 440, self.centre_pt[1]),
                        colour=self.colours['red'], board_value=40)]

        three = [Point(point=(self.centre_pt[0] + 50, self.centre_pt[1]),
        ...
        six = [Point(point=(self.centre_pt[0], self.centre_pt[1] + 50), 
                     colour=self.colours['white'], board_value=6),
               Point(point=(self.centre_pt[0], self.centre_pt[1] + 270),
                     colour=self.colours['green'], board_value=18),
               Point(point=(self.centre_pt[0], self.centre_pt[1] + 290),
                     colour=self.colours['white'], board_value=6),
               Point(point=(self.centre_pt[0], self.centre_pt[1] + 440), 
                     colour=self.colours['green'], board_value=12)]

        eleven = [Point(point=(self.centre_pt[0], self.centre_pt[1] - 50), 
        ...
        one = [Point(point=(self.centre_pt[0] - 50, self.centre_pt[1] + 20), 
                     colour=self.colours['white'], board_value=1),
               Point(point=(self.centre_pt[0] - 270, self.centre_pt[1] + 50),
                     colour=self.colours['green'], board_value=3),
               Point(point=(self.centre_pt[0] - 290, self.centre_pt[1] + 60),
                     colour=self.colours['white'], board_value=1),
               Point(point=(self.centre_pt[0] - 440, self.centre_pt[1] + 90), 
                     colour=self.colours['green'], board_value=2)]

        five = [Point(point=(self.centre_pt[0] - 50, self.centre_pt[1] - 20), 
        ...
        seventeen = [Point(point=(self.centre_pt[0] + 50, self.centre_pt[1] + 20), 
        ...
        nineteen = [Point(point=(self.centre_pt[0] + 50, self.centre_pt[1] - 20), 
        ...
        thirteen = [Point(point=(self.centre_pt[0] - 20, self.centre_pt[1] + 50), 
                          colour=self.colours['black'], board_value=13),
                    Point(point=(self.centre_pt[0] - 50, self.centre_pt[1] + 270), 
                          colour=self.colours['red'], board_value=39),
                    Point(point=(self.centre_pt[0] - 60, self.centre_pt[1] + 290), 
                          colour=self.colours['black'], board_value=13),
                    Point(point=(self.centre_pt[0] - 90, self.centre_pt[1] + 440), 
                          colour=self.colours['red'], board_value=26)]

        ten = [Point(point=(self.centre_pt[0] + 20, self.centre_pt[1] + 50), 
        ...
        fourteen = [Point(point=(self.centre_pt[0] - 20, self.centre_pt[1] - 50), 
        ...
        eight = [Point(point=(self.centre_pt[0] + 20, self.centre_pt[1] - 50), 
        ...
        eighteen = [Point(point=(self.centre_pt[0] - 50, self.centre_pt[1] + 40), 
                          colour=self.colours['black'], board_value=18),
                    Point(point=(self.centre_pt[0] - 240, self.centre_pt[1] + 140), 
                          colour=self.colours['red'], board_value=54),
                    Point(point=(self.centre_pt[0] - 290, self.centre_pt[1] + 160), 
                          colour=self.colours['black'], board_value=18),
                    Point(point=(self.centre_pt[0] - 380, self.centre_pt[1] + 220), 
                          colour=self.colours['red'], board_value=36)]

        twelve = [Point(point=(self.centre_pt[0] - 50, self.centre_pt[1] - 40), 
        ...
        two = [Point(point=(self.centre_pt[0] + 50, self.centre_pt[1] + 40), 
        ...
        seven = [Point(point=(self.centre_pt[0] + 50, self.centre_pt[1] - 40), 
                       colour=self.colours['black'], board_value=7),
                 Point(point=(self.centre_pt[0] + 240, self.centre_pt[1] -
        ...
        four = [Point(point=(self.centre_pt[0] - 40, self.centre_pt[1] + 50), 
                      colour=self.colours['white'], board_value=4),
                Point(point=(self.centre_pt[0] - 140, self.centre_pt[1] + 240), 
                      colour=self.colours['green'], board_value=12),
                Point(point=(self.centre_pt[0] - 160, self.centre_pt[1] + 290), 
                      colour=self.colours['white'], board_value=4),
                Point(point=(self.centre_pt[0] - 220, self.centre_pt[1] + 380), 
                      colour=self.colours['green'], board_value=8)]

        fifteen = [Point(point=(self.centre_pt[0] + 40, self.centre_pt[1] + 50), 
        ...
        nine = [Point(point=(self.centre_pt[0] - 40, self.centre_pt[1] - 50), 
        ...
        sixteen = [Point(point=(self.centre_pt[0] + 40, self.centre_pt[1] - 50), 
        ...
        # Save current progress as a wired board
        self.dartboard.wired_board = copy.deepcopy(self.dartboard.board)
    ...
    def floodFillRecursion(self, point, colour, board_value):
        ...
        if not (self.img[point[0]][point[1]] == colour).all() or self.dartboard.board[point[0]][point[1]] == board_value:
            return
        else:
            self.dartboard.board[point[0]][point[1]] = board_value
        ...
        if not (self.img[point[0]][point[1]] == colour).all() or self.dartboard.board[point[0]][point[1]] == board_value:
            ...
            while not q.empty():
                ...
                for pt in [(n[0] + 1, n[1]), (n[0], n[1] + 1), (n[0] - 1, n[1]), (n[0], n[1] - 1)]:
                    if (self.img[pt[0]][pt[1]] == colour).all() and self.dartboard.board[pt[0]][pt[1]] != board_value and (pt[0], pt[1]) not in q.queue:
                        self.dartboard.board[pt[0]][pt[1]] = board_value
                        q.put((pt[0], pt[1]))
    ...
    def calculateMask(self):
        ...
        for i in range(self.board_mask.shape[0]):
            for j in range(self.board_mask.shape[1]):
                d = np.sqrt((self.centre_pt[0]-i) **
                            2 + (self.centre_pt[1]-j)**2)
                if d > r:
    ...
    def allocateWire(self, point):
        ...
        while True:
            ...
            if any(local):
                self.dartboard.board[point[0]][point[1]] = local[0]
                break

    def removeWires(self):
        cur = 0
        for i in range(self.dartboard.board.shape[0]):
            for j in range(self.dartboard.board.shape[1]):
                if self.dartboard.board[i][j] == 0 and self.board_mask[i][j]:
    ...
    def run(self):
        ...
        np.save('dartboard.npy', self.dartboard.board)
        return self.dartboard.board
